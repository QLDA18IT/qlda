    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Add Nhân viên</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">Tên Đệm</label>
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">Info</label>
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">Địa chỉ</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_firstname" class="col-sm-3 control-label">Tên Đệm</label>
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">Info</label>
                ...
                <div class="form-group">
                    <label for="edit_position" class="col-sm-3 control-label">Địa chỉ</label>
